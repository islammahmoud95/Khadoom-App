...
public class TypewriterView extends android.support.v7.widget.AppCompatEditText {
    ...
    private abstract class Repeater implements Runnable {
        ...
        Repeater(Runnable doneRunnable, long delay) {
    ...
    private class TextAdder extends Repeater {
        ...
        TextAdder(CharSequence textToAdd, long speed, Runnable doneRunnable) {
    ...
    private class TextRemover extends Repeater {
        ...
        TextRemover(CharSequence textToRemove, long speed, Runnable doneRunnable) {
            super(doneRunnable, speed);
    ...
    private class TypePauser extends Repeater {
        ...
        TypePauser(long delay, Runnable doneRunnable) {
    ...
    private class TypeRunnable extends Repeater {
        ...
        TypeRunnable(Runnable runnable, Runnable doneRunnable) {
