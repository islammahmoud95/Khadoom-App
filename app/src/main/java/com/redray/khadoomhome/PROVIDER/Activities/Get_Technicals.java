...
import com.redray.khadoomhome.PROVIDER.Adapters.Get_Ticknicals_adapter;
...
public class Get_Technicals extends AppCompatActivity {
    ...
    Get_Ticknicals_adapter productsAdapter;
    ...
    FloatingActionButton add_ticknical;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_technicals);
       ...
       ActionBar actionBar = getSupportActionBar();
        ...
        add_ticknical = findViewById(R.id.add_ticknical);
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener(){
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy){
                if (dy > 0 ||dy<0 && add_ticknical.isShown())
                    add_ticknical.hide();
            }
        ...
        add_ticknical.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent add_tech = new Intent(getApplicationContext(),Add_new_Tecknical.class);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            }else
                            {
                                ...
                                Utility.dialog_error(Get_Technicals.this,s.toString());
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_Ticknicals_adapter(this, productsArrayList);
