 ...
 */
public class Accepted_Orders_frag extends Fragment {
...
* */
    ...
    public void Get_Accepted_Orders() {
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_orders_adapter(getActivity(), productsArrayList,"APPROVED");
