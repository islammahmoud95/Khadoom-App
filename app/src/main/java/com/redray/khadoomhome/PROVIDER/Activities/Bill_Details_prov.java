...
public class Bill_Details_prov extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bill_details_prov);
    ...
    public void get_Bill_Details() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "sp/getInvoiceDetailsSp",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status) {
                                ...
                                Utility.dialog_error(Bill_Details_prov.this, s.toString());
