...
public class Add_service_category extends RecyclerView.Adapter<Add_service_category.RecyclerViewHolder> {
    ...
    public Add_service_category(Activity context, ArrayList<Add_service_items> productsArrayList , DataTransferInterface_Add_Serv dtInterface) {
        ...
        holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (productsArrayList.get(holder.getAdapterPosition()).getcheckbox())
                {
                    ...
                    dtInterface.setValues_services(aray);
                }else {
