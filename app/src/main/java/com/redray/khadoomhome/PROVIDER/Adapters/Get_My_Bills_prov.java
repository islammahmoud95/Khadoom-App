...
import com.redray.khadoomhome.PROVIDER.Activities.Bill_Details_prov;
...
public class Get_My_Bills_prov extends RecyclerView.Adapter<Get_My_Bills_prov.RecyclerViewHolder> {
    ...
    public Get_My_Bills_prov(Activity context, ArrayList<Get_Bills_Items> productsArrayList) {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent go_to_detail = new Intent(context, Bill_Details_prov.class);
