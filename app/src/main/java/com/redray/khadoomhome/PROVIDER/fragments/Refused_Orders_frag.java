 ...
 */
public class Refused_Orders_frag extends Fragment {
...
* */
    ...
    public void Get_Refused_Orders() {
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_orders_adapter(getActivity(), productsArrayList,"REFUSED");
