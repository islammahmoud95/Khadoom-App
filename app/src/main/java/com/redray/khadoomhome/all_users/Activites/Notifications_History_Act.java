...
public class Notifications_History_Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.get_notifications_recycle);
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_My_Notifications(this, productsArrayList);
