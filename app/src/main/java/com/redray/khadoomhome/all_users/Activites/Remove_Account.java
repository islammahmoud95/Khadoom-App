...
public class Remove_Account extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remove_acc_lay = findViewById(R.id.remove_acc_lay);


        Button ok_btn = findViewById(R.id.now_btn);
            ...
            public void onClick(View view) {
                if (Check_Con.getInstance(getApplicationContext()).isOnline()) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(remove_acc_lay, R.string.no_connect, Snackbar.LENGTH_INDEFINITE)
    ...
    public void close_Account() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "RemoveAccount",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status) {
                                ...
                                Intent go_to_Type = new Intent(getApplicationContext(),Account_Type.class);
                                go_to_Type.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                                go_to_Type.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
                                ...
                                Utility.dialog_error(Remove_Account.this, s.toString());
