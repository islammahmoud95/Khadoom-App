...
public class Post_Rating_Order extends AppCompatActivity {
    ...
    TextView order_id_txt, prov_name_txt;
    EditText feedback_msg_edt;

    Button send_rate_btn;
...
//            Log.d("iddddddd",rate_id);
        ...
        prov_name_txt = findViewById(R.id.prov_name);
        ...
        send_rate_btn = findViewById(R.id.send_rate_btn);
        send_rate_btn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void Get_Rate_order() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "users/rateStandards",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status) {
                                ...
                                String order_id = data.getString("orderNumber");
                                String prov_name = data.getString("sp_name");

                                order_id_txt.setText(order_id);
                                prov_name_txt.setText(prov_name);

                              //  JSONArray rates_list = data.getJSONArray("standards");
                                ...
                                Utility.dialog_error(Post_Rating_Order.this, s.toString());
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_My_Rating_list(this, productsArrayList,"POST");
...
//            productsArrayList.clear();
    ...
    public void get_Parts_Json() {
        ...
        for (int i = 0; i < childCount; i++) {
            if (recyclerView.findViewHolderForLayoutPosition(i) instanceof Get_My_Rating_list.RecyclerViewHolder) {

                try {
                    JSONObject jsonObject = new JSONObject();

                    jsonObject.put("type_id", productsAdapter.productsArrayList.get(i).getRate_ID());
                    jsonObject.put("rate", productsAdapter.productsArrayList.get(i).getRate_Num());

                    jsonArray_rating.put(jsonObject);
        ...
        Log.e("printAllEditTextValues", jsonArray_rating.toString());


    }


    public void Send_Rate_provider() {

        get_Parts_Json();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "users/rateOrder",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status) {
                                ...
                                Toast.makeText(getApplicationContext(), R.string.thank_for_rating, Toast.LENGTH_LONG).show();
...

        {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("order_id", order_id);
                params.put("rates", jsonArray_rating.toString());
                params.put("feedback", feedback_msg_edt.getText().toString());
