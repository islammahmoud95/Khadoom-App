 ...
 */
public class New_Orders_tech_frag extends Fragment {
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_orders_tech_adapter(getActivity(), productsArrayList,"NEW");
