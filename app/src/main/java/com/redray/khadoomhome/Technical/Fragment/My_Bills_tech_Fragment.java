...
import com.redray.khadoomhome.Technical.Adapter.Get_My_Bills_tech;
...
public class My_Bills_tech_Fragment extends Fragment {
    ...
    Get_My_Bills_tech productsAdapter;

    SessionManager session;

    public My_Bills_tech_Fragment() {
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_My_Bills_tech(getActivity(), productsArrayList);
