...
public class Order_Details_tech extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_details_tech);
        ...
        done_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Check_Con.getInstance(getApplicationContext()).isOnline()) {
                    ...
                    Intent choose_technical = new Intent(getApplicationContext(),Bill_Details_tech.class);
    ...
    public void get_order_details() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "tech/getOrderDetails",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //    String id_str = data.getString("id");
                                ...
                                Utility.dialog_error(Order_Details_tech.this, s.toString());
