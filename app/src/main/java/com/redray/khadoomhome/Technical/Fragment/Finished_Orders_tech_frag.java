package com.redray.khadoomhome.Technical.Fragment;
...
import com.redray.khadoomhome.Technical.Adapter.Get_orders_tech_adapter;
 ...
 */
public class Finished_Orders_tech_frag extends Fragment {
    ...
    Get_orders_tech_adapter productsAdapter;

    SessionManager session;

    public Finished_Orders_tech_frag() {
...
* */
    ...
    public void Get_Done_Orders() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "tech/getMyOrders",
...
//        if (!productsArrayList.isEmpty()) {
        productsAdapter = new Get_orders_tech_adapter(getActivity(), productsArrayList, "FINISHED");
